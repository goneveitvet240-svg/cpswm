"""Source-bound follow-on inference checks; distinct from the second audit round."""
...
commands = {
    ...
    "checkpoint_inference": [
        python,
        "tools/run_checkpoint_proposal_inference.py",
        "--training",
        str(TRAINING),
        "--output",
        str(OUT / "inference"),
...
report = {
    ...
    "commands": {},
    "scope": "A_LOCAL_FOLLOW_ON_INFERENCE_VALIDATION",
