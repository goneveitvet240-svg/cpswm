"""Source-bound engineering/data/fixture checks; no full acceptance claim."""
...
PUBLIC = Path(sys.argv[3]).resolve()
...
changed = subprocess.check_output(
    [
        ...
        "diff",
        "--name-only",
        "51b29ae79b4867be86311cfc2d7c8f0ae7ec6686",
        "HEAD",
        "--",
        "src",
        "tests",
...
commands = {
    ...
    "hocap_package": [
        python,
        "tools/build_joint_supervision_package.py",
        "--spec",
        str(SPEC),
        "--output",
        str(OUT / "hocap"),
    ...
    "public_package": [
        python,
        "tools/inspect_public_joint_evidence.py",
        "--source",
        str(PUBLIC),
        "--output",
        str(OUT / "public"),
    ...
    "three_arm_training": [
        python,
        "tools/run_typed_proposal_development.py",
        "--output",
        str(OUT / "training"),
        "--steps",
        "4",
    ...
    "joint_correction": [
        python,
        "tools/run_joint_correction_continuation.py",
        "--output",
        str(OUT / "joint"),
        "--seed",
        "11",
    ...
    "existing_correction": [
        python,
        "tools/run_correction_replay_comparison.py",
        "--output",
        str(OUT / "existing"),
        "--seed",
        "11",
...
report = {
    ...
    "commands": {},
    "scope": "A_LOCAL_PARTIAL_ENGINEERING_AND_PUBLIC_DATA_CHECKS",
