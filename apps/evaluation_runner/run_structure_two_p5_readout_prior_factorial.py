...
from cpswm.system.evaluation_operations.structure_two_p5_readout_prior_factorial import (  # noqa: E402
    DEFAULT_OUTPUT,
...
def main() -> None:
    ...
    output = publish_verified_json(
        ...
        args.output,
        payload,
        verify=lambda value: verify_p5_readout_prior_factorial(value, repository_root=root),
    )
    print(
        json.dumps(
            {
