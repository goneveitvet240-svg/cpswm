#!/usr/bin/env python3
"""Open or freshly verify the repository-frozen internal unseen-D0 holdout."""
...
from cpswm.system.evaluation_operations.structure_two_p5_unseen_d0_holdout import (  # noqa: E402
    DEFAULT_OUTPUT,
...
def main() -> None:
    ...
    output = publish_verified_json(
        ...
        args.output,
        payload,
        verify=lambda value: verify_p5_unseen_d0_holdout(value, repository_root=root),
    )
    print(
        json.dumps(
            {
