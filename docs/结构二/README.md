...
2026-09-20 最新：[监督对齐与位姿真值核验](../reviews/pc_a/supervision_alignment_2026-09-20/REPORT.md)。固定工具核查554帧RGB、130帧分割和388位姿，发现024有7行非刚体姿态；对齐候选尚不能授权真值。跨帧梯度问题已修复并独立复跑，完整自然P5及B验收仍未完成。
