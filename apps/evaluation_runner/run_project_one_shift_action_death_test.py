...
DEFAULT_CONFIG = REPOSITORY_ROOT / (
    "benchmarks/project_one_ablation/project_one_shift_action_death_test_v4.json"
)
DEFAULT_OUTPUT = REPOSITORY_ROOT / "output/project_one_shift_action_death_test_v4.json"

SNAPSHOT_PATHS = (
    "apps/evaluation_runner/run_project_one_shift_action_death_test.py",
    "benchmarks/project_one_ablation/project_one_shift_action_death_test_v4.json",
    "docs/reviews/项目一_SHIFT行动级死亡测试预注册_v4.md",
