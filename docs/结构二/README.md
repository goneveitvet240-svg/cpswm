...
2026-09-25 最新：[开发像素跟踪、非空纠错与从头重放](../reviews/pc_a/grounded_correction_2026-09-25/REPORT.md)。64 帧辅助标注与首帧跟踪，三个受控 seed 实际撤销/恢复/重放同语义状态，两个改变放回读出；103 工程回归通过。默认联合粒子 batch 仍缺，自然语义/实际行动/独立强基线未完成，非整体或 B 验收。
