...
def main():
    ...
    files = [ROOT / "src/cpswm/data_preflight/agent_roster.py", Path(__file__),
    ...
    (args.output / "receipt.json").write_text(json.dumps({
        ...
        "python": sys.version, "source_before": before, "source_after": after,
        "source_unchanged": before == after, "rounds": results,
    }, indent=2))
